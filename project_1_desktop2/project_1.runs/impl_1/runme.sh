...
HD_PWD='C:/Users/noelk/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log P10AR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source P10AR.tcl -notrace
