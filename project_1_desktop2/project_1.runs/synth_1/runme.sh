...
HD_PWD='C:/Users/noelk/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log P10AR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source P10AR.tcl
