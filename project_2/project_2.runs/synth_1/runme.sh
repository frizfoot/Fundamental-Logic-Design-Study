...
HD_PWD='C:/Users/noelk/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log P1010.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source P1010.tcl
