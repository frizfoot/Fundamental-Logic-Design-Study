...
REM
REM Generated by Vivado on Tue Aug 25 01:10:43 +0900 2026
...
echo "xvlog --incr --relax -L uvm -prj P1010s_vlog.prj"
call xvlog  --incr --relax -L uvm -prj P1010s_vlog.prj -log xvlog.log
