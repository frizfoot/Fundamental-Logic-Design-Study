...
HD_PWD='C:/Users/noelk/practice_1/practice_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wires.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wires.tcl
