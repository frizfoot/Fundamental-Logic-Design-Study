...
REM
REM Generated by Vivado on Mon Jun 01 20:30:02 +0900 2026
...
echo "xvlog --incr --relax -L uvm -prj thermostat_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj thermostat_tb_vlog.prj -log xvlog.log
