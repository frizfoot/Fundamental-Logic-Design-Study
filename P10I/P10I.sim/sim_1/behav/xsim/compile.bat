...
REM
REM Generated by Vivado on Sat Aug 29 02:29:56 +0900 2026
...
echo "xvlog --incr --relax -L uvm -prj simul_vlog.prj"
call xvlog  --incr --relax -L uvm -prj simul_vlog.prj -log xvlog.log
