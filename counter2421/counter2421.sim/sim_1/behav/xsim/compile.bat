...
REM
REM Generated by Vivado on Tue Sep 08 01:29:14 +0900 2026
...
echo "xvlog --incr --relax -L uvm -prj counter2421_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj counter2421_tb_vlog.prj -log xvlog.log
