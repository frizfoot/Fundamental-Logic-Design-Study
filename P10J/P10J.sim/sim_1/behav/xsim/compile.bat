...
REM
REM Generated by Vivado on Sun Aug 30 02:04:46 +0900 2026
...
echo "xvlog --incr --relax -L uvm -prj mas_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj mas_tb_vlog.prj -log xvlog.log
