...
REM
REM Generated by Vivado on Sun Aug 30 22:36:22 +0900 2026
...
echo "xvlog --incr --relax -L uvm -prj master_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj master_tb_vlog.prj -log xvlog.log
