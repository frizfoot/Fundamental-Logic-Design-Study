...
REM
REM Generated by Vivado on Sun Aug 30 00:56:42 +0900 2026
...
echo "xvlog --incr --relax -L uvm -prj mEnc_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj mEnc_tb_vlog.prj -log xvlog.log
